...
[user])
  ...
  return (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      ...
      <div className='bg-white h-full wfull
       rounded-xl overflow-y-scroll'>
        {creations.map((creation,index)=>(
          <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3'>
            ...
            <div className='absolute bottom-0 top-0 right-0 left-3 flex gap-2 items-end justify-end group-hover:justify-between p-3 group-hover:bg-gradient-to-b from transparent to-black/80 text-blue-400 rounded-lg'>
              <p className='tetx-sm hidden group-hover:block'> {creation.prompt}</p>

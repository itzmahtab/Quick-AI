...
const AiTools = () => {
  ...
  <div className='flex flex-wrap mt-10 justify-center '>
    {AiToolsData.map((tool, index) =>(
        <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-200 hover:-translate-y-1  s transition-all duration-300 cursor-pointer' onClick={()=>user && navigate(tool.path)}>
